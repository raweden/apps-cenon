 ...
 *
 * created:  1996-05-01
 * modified: 2013-04-16 (style added to group)
 *           2011-04-04 (DXFGroup: z coordinates added)
...
typedef struct _DXFState
{
    ...
    NSString    *layer;         // layer overriding the layer in group.layer (for INSERT)
}DXFState;
...
@interface DXFImport:NSObject
{
    ...
    NSDictionary    *table;         // table dictionary with entries: "layer", "style", ...
